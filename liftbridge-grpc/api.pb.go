...
type SubscribeRequest struct {
	...
	StartPosition  StartPosition `protobuf:"varint,4,opt,name=startPosition,proto3,enum=proto.StartPosition" json:"startPosition,omitempty"`
	StartOffset    int64         `protobuf:"varint,5,opt,name=startOffset,proto3" json:"startOffset,omitempty"`
...
type StreamMetadata struct {
	...
	Partitions map[int32]*PartitionMetadata `protobuf:"bytes,3,rep,name=partitions" json:"partitions,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*PartitionMetadata) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{10} }
...
func (*Message) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{11} }
...
func (*Ack) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{12} }
...
var fileDescriptorApi = []byte{
	...
	,
}
